...
module.exports.test = (uiTestCtx) => {
  describe('Module test: ui-orders:', function() {
    ...
    describe('Login > navigate to app > verify message > logout', () => {
      ...
      it('should open app and see stripes-new-app-greeting', (done) => {
        nightmare
          .wait('#clickable-orders-module')
          .click('#clickable-orders-module')
          .wait('#orders-module-display')
    ...
    describe('Login > navigate to app settings > verify message > logout', () => {
      ...
      it('should open app settings and see stripes-new-app-settings-message', (done) => {
        nightmare
          ...
          .wait('a[href="/settings/orders"]')
          .click('a[href="/settings/orders"]')
          .wait('a[href="/settings/orders/general"]')
          .click('a[href="/settings/orders/general"]')
